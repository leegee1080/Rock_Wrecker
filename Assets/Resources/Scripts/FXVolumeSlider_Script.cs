...
public class FXVolumeSlider_Script : MonoBehaviour
{
    ...
    public void UpdateVolumeTicks()
    {
        ...
        _volume = Overallgame_Controller_Script.overallgame_controller_singleton.CurrentPlayer.fxVol;
    ...
    {   
        ...
        Overallgame_Controller_Script.overallgame_controller_singleton.CurrentPlayer.fxVol = _volume;
