...
public class MusicVolumeSlider_Script : MonoBehaviour
{
    ...
    public void UpdateVolumeTicks()
    {
        ...
        _volume = Overallgame_Controller_Script.overallgame_controller_singleton.CurrentPlayer.musicVol;
    ...
    {   
        ...
        Overallgame_Controller_Script.overallgame_controller_singleton.CurrentPlayer.musicVol = _volume;
        UpdateVolumeTicks();
    }
